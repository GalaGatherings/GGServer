...
class Auth with ChangeNotifier {
  ...
  String logo_url = '';
  String baseUrl = "https://galagatherings.com/";
  String? fcmToken = '';
...
/*  String get_user_id() {
  ...
  Future<void> acceptOrder(
    ...
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/accept"),
      headers: headers,
      body: jsonEncode({
        "user_id": userId,
  ...
  Future<void> statusChange(
    ...
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/status-change"),
      headers: headers,
      body: jsonEncode({
        "user_id": userId,
        "order_from_user_id": orderFrom,
  ...
  Future<void> rejectOrder(
      String orderId, String userId, String orderFrom) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/reject"),
      headers: headers,
      body: jsonEncode({
        "user_id": userId,
        "order_from_user_id": orderFrom,
  ...
  Future<dynamic> assignDeliveryPartnerUengage(
      String orderId, String userId, String orderFrom) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/assign_delivery"),
      headers: headers,
      body: jsonEncode({
        "user_id": userId,
        "order_from_user_id": orderFrom,
  ...
  Future<dynamic> getTaskStatus(taskId) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/task_status"),
      headers: headers,
      body: jsonEncode({
        "task_id": taskId,
      }),
  ...
  Future<dynamic> cancelDeliveryTask(taskId, orderFrom, userId, orderId) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/cancel_task"),
      headers: headers,
      body: jsonEncode({
        "task_id": taskId,
        "user_id": userId,
  ...
  Future<dynamic> cancelDelivery(taskId) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/cancel_delivery"),
      headers: headers,
  ...
  Future<void> markOrderAsDelivered(
      String orderId, String userId, String orderFrom) async {
    final response = await http.post(
      Uri.parse("https://galagatherings.com/order/delivered"),
      headers: headers,
      body: jsonEncode({
        "user_id": userId,
        "order_from_user_id": orderFrom,
  ...
  Future createNewCoupons(selectedCouponType, discountValue, minCartValue,
    ...
    final String url = 'https://galagatherings.com/coupons/create';
  ...
  Future getCouponsByUserId() async {
    final String url = 'https://galagatherings.com/coupons/get';
  ...
  Future getDistance(sellerUserId, latitude, longitude) async {
    final String url = 'https://galagatherings.com/get_distance';
  ...
  Future updateCoupon(String couponId, Map<String, dynamic> updData) async {
    final String url = 'https://galagatherings.com/coupons/update';
  ...
  Future deleteCoupon(couponId) async {
    final String url = 'https://galagatherings.com/coupons/delete';
  ...
  Future<void> getNotificationList() async {
    try {
      final response = await http.post(
        Uri.parse("https://galagatherings.com/get-notification"),
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      final orders = await http.post(
        Uri.parse("https://galagatherings.com/order/get"),
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      final payments = await http.post(
        Uri.parse("https://galagatherings.com/payments/get"),
        headers: {
          'Content-Type': 'application/json',
        },
        body: jsonEncode({
...
// Use a default value of '0' if itemAdd[idx].price is null
  ...
  Future<Map<String, dynamic>> commonLogin(
    ...
    final String url = 'https://galagatherings.com/common-login';
  ...
  Future sendUserTypeRequest() async {
    final String url = 'https://galagatherings.com/user-type';
  ...
  Future<String> updateMenuItem(String product_id, String price, String name,
    ...
    final String url = 'https://galagatherings.com/product/update';
    // print(VEG);
...
Future<void> updateBusinessType(String category, String subCategory) async {
  ...
  Future<String> pickImageAndUpoad(BuildContext context,
    ...
    try {
      final url = Uri.parse('https://galagatherings.com/upload');
  ...
  Future<dynamic> ScanMenu(String src) async {
    ...
    try {
      final url = Uri.parse('https://galagatherings.com/upload-menu');
...
//  List<int> imageBytes = File(compressedImage as String).readAsBytesSync();
  ...
  Future<String> AddProductsForMenu(List<dynamic> data) async {
    final String url = 'https://galagatherings.com/product/add';
  ...
  Future<String> updateDescriptionAndType() async {
    final String url =
        'https://galagatherings.com/product/update-default-description';
  ...
  Future<String> updateSingleDescription(productName) async {
    final String url =
        'https://galagatherings.com/product/update-single-description';
  ...
  Future<String> createPost(List<String> list, List<String> tags,
    ...
    final String url = 'https://galagatherings.com/metadata/feed';
    List<String> idList = [];
  ...
  Future<dynamic> getGlobalFeed(int index) async {
    final String url = 'https://galagatherings.com/get-posts';
    final data = {
      "page": index,
      "limit": 10,
    };
  ...
  Future<dynamic> follow(String id) async {
    final String url = 'https://galagatherings.com/follow';
  ...
  Future<dynamic> askBellyGPT(String prompt) async {
    final String url = 'https://galagatherings.com/belly-gpt';
  ...
  Future<Uint8List?> bellyAiTextToImage(String prompt) async {
    final String url = 'https://galagatherings.com/text-to-image';
  ...
  Future<dynamic> unfollow(String id) async {
    final String url = 'https://galagatherings.com/unfollow';
  ...
  Future<dynamic> updateProductImageusingAI(
    ...
    final String url = 'https://galagatherings.com/product/update-ai-image';
  ...
  Future<String> commentPost(String id, String comment) async {
    final String url = 'https://galagatherings.com/update-posts';
  ...
  Future<String> deleteComment(String id, String comment) async {
    final String url = 'https://galagatherings.com/delete-comment';
  ...
  Future<String> sendOtp(String mobile_no) async {
    final String url = 'https://galagatherings.com/otp/send_otp';
  ...
  Future<Map<String, dynamic>> verifyOtp(String mobile_no, String otp) async {
    const String url = 'https://galagatherings.com/otp/verify_otp';
  ...
  Future<String> deleteProfile(String mobile_no) async {
    const String url = 'https://galagatherings.com/delete-profile';
  ...
  Future<String> deletePost(String id) async {
    final String url = 'https://galagatherings.com/delete-posts';
  ...
  Future<List<dynamic>> getUserInfo(List<dynamic> list) async {
    final String url = 'https://galagatherings.com/get-user-info';
...
// for getting upi
  ...
  Future<dynamic> getInventoryData() async {
    ...
    final String url = 'https://galagatherings.com/inventory/get-data';
    ...
    try {
      final response = await http.post(
        ...
        headers: {
          ...
          'Referer': 'https://galagatherings.com/inventory',
  ...
  Future<dynamic> cartInventory(List<dynamic> data) async {
    // id = '65e31e9f0bf98389f417cf71';
    final String url = 'https://galagatherings.com/cart/add';
  ...
  Future<dynamic> saveInventoryData(List<dynamic> data) async {
    // id = '65e31e9f0bf98389f417cf71';
    final String url = 'https://galagatherings.com/inventory/save-data';
    print(data);
    // bool _isOK = false;
