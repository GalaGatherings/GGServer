...
import 'package:gala_gatherings/widgets/horizontal_list.dart';
                  ...
                  decoration: ShapeDecoration(
                    shadows: [
                      BoxShadow(
                        offset: Offset(3, 6),
                        color:
                            Color.fromRGBO(158, 116, 158, 0.5).withOpacity(0.3),
                        blurRadius: 20,
                      )
                    ],
                    shape: SmoothRectangleBorder(),
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: Text(
                                    "USD ${widget.productList[index].totalPrice.toString()}",
                                    style: const TextStyle(
                                      color: Color(0xFF2E0536),
                                      fontSize: 18,
                                      fontFamily: 'Product Sans',
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        '${tempList.length} Items   |   USD $allProductPrice',
                        style: const TextStyle(
